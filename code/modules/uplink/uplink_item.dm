...
/datum/uplink_item/badass/bear
	name = "Instant Bear"
	desc = "Exactly what it says. It instantly teleports in an angry bear that is hostile to both you and everyone else. Best used while being chased."
	item = /mob/living/simple_animal/hostile/bear
	cost = 1 //Regular bears have 60 health.
	surplus = 2 //RNG hates you. I hope this won't break traitor cargo
	exclude_modes = list(/datum/game_mode/nuclear)

/datum/uplink_item/badass/combatbear
	name = "Instant Combat Bear"
	desc = "Exactly what it says. It instantly teleports in an angry combat bear that is hostile to both you and everyone else. Best used while being chased, but you want whoever is chasing you dead."
	item = /mob/living/simple_animal/hostile/bear/russian
	cost = 2 //Combat bears have 120 health
